import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, ref, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, unref, Suspense, nextTick, mergeProps, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/nashi/malias-7-8/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/nashi/malias-7-8/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from "C:/Users/nashi/malias-7-8/node_modules/h3/dist/index.mjs";
import { shouldHydrate, defineStore, createPinia, setActivePinia } from "pinia";
import { defu } from "C:/Users/nashi/malias-7-8/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "C:/Users/nashi/malias-7-8/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/Users/nashi/malias-7-8/node_modules/ufo/dist/index.mjs";
import { parse } from "C:/Users/nashi/malias-7-8/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr, { destr as destr$1 } from "C:/Users/nashi/malias-7-8/node_modules/destr/dist/index.mjs";
import { isEqual } from "C:/Users/nashi/malias-7-8/node_modules/ohash/dist/index.mjs";
import { klona } from "C:/Users/nashi/malias-7-8/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import("./_nuxt/admin-0-K3cVt7.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B1vaQkbQ.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-B43bLAo4.js")
  },
  {
    name: "upload",
    path: "/upload",
    component: () => import("./_nuxt/upload-DWQ3U13P.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-BGyRG8ST.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-h6dtpQw-.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/dashboard-CJqwiCkP.js")
  },
  {
    name: "favorites-all",
    path: "/favorites/all",
    component: () => import("./_nuxt/all-9HzZdesP.js")
  },
  {
    name: "favorites",
    path: "/favorites",
    component: () => import("./_nuxt/index-lbhdEE5p.js")
  },
  {
    name: "folder-folder",
    path: "/folder/:folder()",
    component: () => import("./_nuxt/_folder_-CVYJPD0J.js")
  },
  {
    name: "product-details-id",
    path: "/product-details/:id()",
    component: () => import("./_nuxt/_id_-NKEhYsoi.js")
  },
  {
    name: "favorites-details-id",
    path: "/favorites/details/:id()",
    component: () => import("./_nuxt/_id_-BTgMszRt.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BSe7_X8J.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CRQKz7lf.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BZB_xaBP.js"));
