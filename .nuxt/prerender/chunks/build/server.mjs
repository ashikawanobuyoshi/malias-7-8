import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, ref, Suspense, shallowReactive, Fragment, defineAsyncComponent, computed, unref, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope } from 'file://C:/Users/nashi/malias-7-8/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file://C:/Users/nashi/malias-7-8/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file://C:/Users/nashi/malias-7-8/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestHeader, setCookie, getCookie, deleteCookie, appendHeader } from 'file://C:/Users/nashi/malias-7-8/node_modules/h3/dist/index.mjs';
import { defineStore, createPinia, setActivePinia, shouldHydrate } from 'file://C:/Users/nashi/malias-7-8/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file://C:/Users/nashi/malias-7-8/node_modules/defu/dist/defu.mjs';
import { RouterView, useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/nashi/malias-7-8/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Users/nashi/malias-7-8/node_modules/radix3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/nashi/malias-7-8/node_modules/ufo/dist/index.mjs';
import { parse } from 'file://C:/Users/nashi/malias-7-8/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/nashi/malias-7-8/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file://C:/Users/nashi/malias-7-8/node_modules/ohash/dist/index.mjs';
import { klona } from 'file://C:/Users/nashi/malias-7-8/node_modules/klona/dist/index.mjs';
import { deepPickUnsafe, deepOmitUnsafe } from 'file://C:/Users/nashi/malias-7-8/node_modules/deep-pick-omit/dist/index.mjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/Users/nashi/malias-7-8/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-0-K3cVt7.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B1vaQkbQ.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-B43bLAo4.mjs')
  },
  {
    name: "upload",
    path: "/upload",
    component: () => import('./upload-DWQ3U13P.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-BGyRG8ST.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./products-h6dtpQw-.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-CJqwiCkP.mjs')
  },
  {
    name: "favorites-all",
    path: "/favorites/all",
    component: () => import('./all-9HzZdesP.mjs')
  },
  {
    name: "favorites",
    path: "/favorites",
    component: () => import('./index-lbhdEE5p.mjs')
  },
  {
    name: "folder-folder",
    path: "/folder/:folder()",
    component: () => import('./_folder_-CVYJPD0J.mjs')
  },
  {
    name: "product-details-id",
    path: "/product-details/:id()",
    component: () => import('./_id_-NKEhYsoi.mjs')
  },
  {
    name: "favorites-details-id",
    path: "/favorites/details/:id()",
    component: () => import('./_id_-BTgMszRt.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BSe7_X8J.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CRQKz7lf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BZB_xaBP.mjs'));
...
export { __nuxt_component_0$2 as _, useAuthStore as a, useRequestFetch as b, useRoute as c, useNuxtApp as d, entry$1 as default, asyncDataDefaults as e, fetchDefaults as f, createError as g, useRouter as h, useRuntimeConfig as i, nuxtLinkDefaults as j, __nuxt_component_0 as k, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useCookie as u };
