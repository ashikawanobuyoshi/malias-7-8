...
const _dirname = (0, _path.dirname)((0, _url.fileURLToPath)("file:///C:/Users/nashi/malias-7-8/nuxt.config.ts"));var _default = exports.default =
...
(0, _config.defineNuxtConfig)({
  ...
  vite: {
    resolve: {
      alias: {
        '@': (0, _path.resolve)(_dirname, 'src'),
        '~': (0, _path.resolve)(_dirname, '.'),
        '~~': (0, _path.resolve)(_dirname, '.'),
        '@assets': (0, _path.resolve)(_dirname, 'src/assets')
      }
    }
  },
